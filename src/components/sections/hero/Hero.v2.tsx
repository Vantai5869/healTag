...
export default function HeroV2({ config, theme }: HeroProps) {
  ...
  return (
    <section className="relative mt-8 overflow-hidden rounded-2xl">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-85" style={{ background: `linear-gradient(90deg, ${gradientFrom} 0%, ${gradientTo} 100%)`, mixBlendMode: 'multiply' as any }} />
      </div>
      <div className="relative z-10 px-6 py-12 md:px-10 md:py-16">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-12 items-center gap-8">
          <div className="md:col-span-7 text-white">
            ...
            <h1 className="text-3xl md:text-5xl font-black leading-tight">Chăm sóc sức khỏe toàn diện cho gia đình bạn</h1>
            <p className="mt-4 max-w-[640px] text-white/85 text-sm md:text-base">Đặt lịch nhanh, đội ngũ chuyên gia tận tâm, công nghệ hiện đại. Luôn đồng hành cùng bạn 24/7.</p>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <button className="px-5 py-3 rounded-lg font-semibold text-[#0B1A37] bg-white hover:bg-white/95 transition cursor-pointer">Đặt lịch ngay</button>
            </div>
          </div>
